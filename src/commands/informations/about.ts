...
import { mrlion_id, author_name } from '../../../config.json'
  ...
  const about = new EmbedBuilder()
    ...
    .setDescription(
      `Hello, I'm LionBot 🦁!
       ...
       You can find my code written in **Typescript** on Mrlion's [Github](https://github.com/L0stedMrlion/lionsproject-dsbot-v3)! This is version **${version}**.
